...
class BasicModelTest(TestCase):
    ...
    def test_basic_question_answering(self):
        ...
        question = Question.objects.get(question.id) # refresh model
    ...
    def test_private_states(self):
        """
        Walk through the public and private states for Question, and public, private,
        ...
        question = Question.objects.get(question.id) # refresh model
        response = Response.objects.get(response.id) # refresh model
        self.assertEquals(response.status, 'inherit')
